...
export const WRITABLE_DIR_PATTERNS: readonly RegExp[] = [
  /\/tmp\//i,
  /\/var\/tmp\//i,
  /\/dev\/shm\//i,
  /\/tmp$/i,
 ...
 */
export function isExternalAddr(addr: string): boolean {
  if (addr.startsWith("127.") || addr === "0.0.0.0" || addr === "::1") return false;
