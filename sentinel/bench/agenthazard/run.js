...
import { loadDataset, sampleDataset, summarizeDataset, } from "./adapter.js";
...
function parseCategory(value) {
    if (AGENTHAZARD_CATEGORIES.includes(value)) {
        return value;
    }
    throw new Error(`Unknown category: ${value}`);
}
function parseMethod(value) {
    if (AGENTHAZARD_JAILBREAK_METHODS.includes(value)) {
        return value;
    }
