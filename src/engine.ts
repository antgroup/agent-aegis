...
import {
  type DefenseMode,
  resolveAgentAegisPluginConfig,
  resolveAgentAegisStateDir,
  resolveSkillScanRoots,
  type AgentAegisPluginConfig,
} from "./config.js";
import {
...
export class AegisDefenseEngine {
  public readonly state: AgentAegisState;
  public readonly scanService: SkillScanService;
  public readonly logger: AegisLogger;
  public readonly config: AgentAegisPluginConfig;
  ...
  constructor(
    ...
    this.stateDir = options?.stateDir ?? resolveAgentAegisStateDir(this.api as any);
...
async function resolveProtectedRoots(api: any, stateDir: string, config: AgentAegisPluginConfig): Promise<string[]> {
